...
class UpdateTrainingScheduleRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'schedules.*.start_time' => 'sometimes|date_format:H:i',
            'schedules.*.end_time' => 'sometimes|date_format:H:i|after:schedules.*.start_time',
    ...
    public function messages()
    {
        return [
            ...
            'schedules.*.day_of_week.sometimes' => 'اليوم مطلوب.',
            'schedules.*.day_of_week.in' => 'اليوم غير صالح.',
            'schedules.*.start_time.sometimes' => 'وقت البداية مطلوب.',
