...
class LicenseRequestRejectedNotification extends Notification
{
    ...
    {
        return [
            'title' => ' ❌ تم رفض طلب الرخصة و استرداد مبلغك بالكامل ',
            'body'  => "تم رفض طلبك للرخصة بالكود: {$this->licenseRequest->license->code}. السبب: {$this->reason} و استرداد مبلغك بالكامل",
